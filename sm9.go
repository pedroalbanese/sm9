...
func initP256() {
	sm9 = new(Curve)
	sm9.P, _ = new(big.Int).SetString("B640000002A3A6F1D603AB4FF58EC74521F2934B1A7AEEDBE56F9B27E351457D", 16)
	sm9.N, _ = new(big.Int).SetString("B640000002A3A6F1D603AB4FF58EC74449F2934B18EA8BEEE56EE19CD69ECF25", 16)
	sm9.B, _ = new(big.Int).SetString("05", 16)
	sm9.Gx, _ = new(big.Int).SetString("93DE051D62BF718FF5ED0704487D01D6E1E4086909DC3280E8C4E4817C66DDDD", 16)
	sm9.Gy, _ = new(big.Int).SetString("21FE8DDA4F21E607631065125C395BBC1C1C00CBFA6024350C464CD70A3EA616", 16)
	sm9.BitSize = 256
}
